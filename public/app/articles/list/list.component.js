    ...
    return {
        ...
        execute: function() {
            ListComponent = (function () {
                function ListComponent(_router, _route, _articlesService) {
                ...
                ListComponent.prototype.update = function (value) {
                    var _this = this;
                    this.article = value;
                    console.log('Name:' + this.article.firstName);
                    this._articlesService.update(this.article).subscribe(function (savedArticle) { return _this._router.navigate(['/articles']); }, function (error) { return _this.errorMessage = error; });
                };
