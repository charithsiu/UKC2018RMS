System.register(['@angular/core', '@angular/router', '../register.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            Register_step1Component = (function () {
                function Register_step1Component(_registerService, _router) {
                    this._registerService = _registerService;
                    this._router = _router;
                    this.register = {};
                }
                Register_step1Component.prototype.save4step1 = function () {
                    var _this = this;
                    this._registerService.save4step1(this.register)
                        .subscribe(function (result) { return _this._router.navigate(['/register', result._id, 'step2']); }, function (error) { return _this.errorMessage = error; });
                };
                Register_step1Component.prototype.ngAfterViewInit = function () {
                ...
                Register_step1Component = __decorate([
                    core_1.Component({
                        selector: 'step1',
                ...
                return Register_step1Component;
            }());
            exports_1("Register_step1Component", Register_step1Component);
        }
    }
});
//# sourceMappingURL=register_step1.component.js.map