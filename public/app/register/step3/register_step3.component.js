System.register(['@angular/core', '@angular/router', '../register.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            Register_step3Component = (function () {
                function Register_step3Component(_registerService, _router) {
                ...
                return Register_step3Component;
            }());
            exports_1("Register_step3Component", Register_step3Component);
        }
    }
});
//# sourceMappingURL=register_step3.component.js.map